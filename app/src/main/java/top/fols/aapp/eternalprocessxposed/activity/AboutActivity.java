    ...
    public void onClick(View view) {
        switch (view.getId()) {
			case R.id.open_github: 
				XTool.openLink(this,"https://github.com/xiaoxinwangluo/android_xposedapp_eternalprocessxposed");
				break;
            case R.id.tv_version:
				XTool.openLink(this,"http://repo.xposed.info/module/top.fols.aapp.eternalprocessxposed");
				break;
			case R.id.tv_author_wawashiwo:
				XTool.openLink(this,"http://www.coolapk.com/u/704928");
				break;
            case R.id.tv_technical_support_neigeshui233:
				XTool.openLink(this,"http://www.coolapk.com/u/933427");
				break;
