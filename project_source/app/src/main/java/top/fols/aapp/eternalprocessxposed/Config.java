...
public class Config {
	final static public String thisClassSimpleName = "Config";
	...
	final static public int version = 28;
	final static public Object sync = new Object();
	final static public lockMessage[] nullLockMessage = new lockMessage[0];
	...
	public static lockMessage[] getPackageList(File file) {
		synchronized (sync) {
			...
			Map<String,lockMessage> list = new HashMap<>();
			try {
	...
	public static final String lockPackageNameListFileName = "locked_semi_eternal";
	...
	private static File packageNameListDirFile = null;
	...
	public static File getPackageNameListXSharedPreferencesDirFile() {
		if (packageNameListDirFile == null)
			packageNameListDirFile = getXSharedPreferencesFile(ThisPackageName, lockPackageNameListFileName);
		return packageNameListDirFile;
	}
	...
	public static File getPackageNameListSharedPreferencesDirFileAndUpdatePermissions(Context context) {
		File f = new File(SharedPreferencesUtils.getDirFilePathAndUpdatePermissions(context, lockPackageNameListFileName));
		return f;
	}
	...
	static public class lockMessage {
		public static final Map<String,lockMessage> toMap(lockMessage...arr) {
			Map<String,lockMessage> hash = new HashMap<>();
